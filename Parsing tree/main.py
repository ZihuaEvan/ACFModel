...
def parse():
    ...
    parser.add_argument('-model_dir',default='train_model2',help='output model weight dir')
    ...
    parser.add_argument('-test', default =True ,action='store_true',help='whether test')
